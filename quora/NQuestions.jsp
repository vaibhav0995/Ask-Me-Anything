...
<%
   ...
   String aquery="SELECT question_bank.* FROM question_bank LEFT JOIN answer_bank ON(question_bank.questionId"; 
   String bquery="= answer_bank.questionId) WHERE answer_bank.questionId IS NULL order by question_bank.number DESC";
   String query=aquery+bquery;
    ...
    <td>
     <form action="Follow.jsp" method="get">
      ...
      <%
		  ...
		  {
	  %>
              <h2 align="center">No question unanswered yet !</h2>
      <%
		  }
	  %>
      </td>
