...
<table width="983" border="0">
  ...
  <tr>
    <td width="704" bgcolor="#FFFFFF">&nbsp;</td>
    <form action="Notifications.jsp" method="post">
    <td width="131"><div align="right">
      <div align="right">
        <input type="submit" name="notifications" id="notifications" class="btn info" value="notifications" />
      </div>
    </td>
    </form>
    ...
    <td width="131"><div align="right">
      <div align="right">
        <input type="submit" name="logout" id="logout" class="btn info" value="Log Out" />
      </div>
    </td>
    </form>
  </tr>
